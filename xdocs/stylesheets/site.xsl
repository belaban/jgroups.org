...
<!-- $Id: site.xsl,v 1.3 2010/11/15 13:25:57 belaban Exp $ -->
  ...
  <xsl:template match="document">
    ...
    <table border="0" width="100%" cellspacing="4">
      ...
      <tr><td colspan="2">
        ...
        <xsl:comment>JGroups</xsl:comment>
        <a href="http://www.jgroups.org/">
          <img src="http://www.jgroups.org/images/javagroups-logo.gif"
             align="left" alt="JGroups Logo" border="0"/>
        </a>
